  ...
  \item Energy Evolution
    ...
    \begin{itemize}
      ...
      \item This allows us to rewrite the Hubble parameter as:
        ...
        $$\frac{H(a)}{H_o}=\left( \Omega_{m}a^{-3}+\Omega_ra^{-4}+\Omega_{\labda}+\Omega_{\kappa}a^{-2} \right)^{\frac{1}{2}}$$

      \item We can then write in terms of the redshift:

        $$\frac{H(z)}{H_o}=\left( \Omega_{m}(1+z)^{3}+\Omega_r(1+z)^{4}+\Omega_{\labda}+\Omega_{\kappa}(1+z)^{2} \right)^{\frac{1}{2}}$$
